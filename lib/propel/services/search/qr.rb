# lib/propel/services/search/qr.rb
module Propel
  module Services
    module Search
      class Qr < Base
        ...
        def perform
          ...
          Propel.logger.info "Performing QR code search", context: search_context
        ...
        private
          ...
          def handle_successful_search(result)
            Propel.logger.info "Found matching result", context: result_context(result)
          ...
          def handle_empty_search
            Propel.logger.warn "No matches found", context: search_context
