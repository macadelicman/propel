    ...
    module Generators
      class RollLabel < Base
        ...
        protected
          ...
          def generate_pdf
            Propel.logger.info "Generating roll labels PDF", context: roll_context
        ...
        private
          ...
          def validate_required_data!
            unless variant_identifier
              raise Propel::Errors::Error, "Variant identifier must be provided"
            end

            unless variant_price || image_data
              raise Propel::Errors::Error, "Either variant price or image data must be provided"
            end
          end
