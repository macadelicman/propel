# lib/propel/pdf/generators/barcode.rb
require 'barby'
  ...
  module Pdf
    module Generators
      class Barcode < Base
        ...
        def generate_pdf
          Propel.logger.info "Generating barcode PDF", context: barcode_context
        ...
        def validate_barcode_data!
          unless variant_identifier && (barcode_content || qr_code_data)
            raise Propel::Errors::Error, "Variant identifier and either barcode content or QR code data must be provided"
          end
        end
      ...
      class BarcodeQr < Barcode
        ...
        def generate_pdf
          Propel.logger.info "Generating barcode QR PDF", context: barcode_context
        ...
        def validate_qr_data!
          unless qr_code_data
            raise Propel::Errors::Error, "QR code data must be provided for BarcodeQr generation"
          end
        end
      end
    end
